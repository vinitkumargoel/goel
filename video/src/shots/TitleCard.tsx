...
const RISE = 14;
const SETTLE = 6;
const OVERSHOOT = -10; // percent — never revert to 6; -10 is the card's raised value.
const FONT_SIZE = 96;
const LINE2_CUE = 10;
  ...
  <div style={{ display: 'flex' }}>
    {text.split('').map((c, i) => (
      <div
        key={i}
        style={{
          // The 0.35em of head room above the cap line is what holds the overshoot; the bottom edge is the cut line.
          overflow: 'hidden',
